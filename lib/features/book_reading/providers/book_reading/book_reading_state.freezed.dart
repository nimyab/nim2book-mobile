...
mixin _$BookReadingState {
 ...
 String get bookId; List<ChapterAlignNode?> get chapters; int get currentChapterIndex; int? get selectedParagraphIndex; int? get selectedWordIndex; bool get prefsLoaded;
...
@override
int get hashCode => Object.hash(runtimeType,bookId,const DeepCollectionEquality().hash(chapters),currentChapterIndex,selectedParagraphIndex,selectedWordIndex,prefsLoaded);

@override
String toString() {
  return 'BookReadingState(bookId: $bookId, chapters: $chapters, currentChapterIndex: $currentChapterIndex, selectedParagraphIndex: $selectedParagraphIndex, selectedWordIndex: $selectedWordIndex, prefsLoaded: $prefsLoaded)';
}
...
@useResult
$Res call({
 String bookId, List<ChapterAlignNode?> chapters, int currentChapterIndex, int? selectedParagraphIndex, int? selectedWordIndex, bool prefsLoaded
});
...
/// Create a copy of BookReadingState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? bookId = null,Object? chapters = null,Object? currentChapterIndex = null,Object? selectedParagraphIndex = freezed,Object? selectedWordIndex = freezed,Object? prefsLoaded = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String bookId,  List<ChapterAlignNode?> chapters,  int currentChapterIndex,  int? selectedParagraphIndex,  int? selectedWordIndex,  bool prefsLoaded)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BookReadingState() when $default != null:
return $default(_that.bookId,_that.chapters,_that.currentChapterIndex,_that.selectedParagraphIndex,_that.selectedWordIndex,_that.prefsLoaded);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String bookId,  List<ChapterAlignNode?> chapters,  int currentChapterIndex,  int? selectedParagraphIndex,  int? selectedWordIndex,  bool prefsLoaded)  $default,) {final _that = this;
switch (_that) {
case _BookReadingState():
return $default(_that.bookId,_that.chapters,_that.currentChapterIndex,_that.selectedParagraphIndex,_that.selectedWordIndex,_that.prefsLoaded);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String bookId,  List<ChapterAlignNode?> chapters,  int currentChapterIndex,  int? selectedParagraphIndex,  int? selectedWordIndex,  bool prefsLoaded)?  $default,) {final _that = this;
switch (_that) {
case _BookReadingState() when $default != null:
return $default(_that.bookId,_that.chapters,_that.currentChapterIndex,_that.selectedParagraphIndex,_that.selectedWordIndex,_that.prefsLoaded);case _:
  return null;
...
class _BookReadingState implements BookReadingState {
  const _BookReadingState({required this.bookId, required final  List<ChapterAlignNode?> chapters, required this.currentChapterIndex, required this.selectedParagraphIndex, required this.selectedWordIndex, this.prefsLoaded = false}): _chapters = chapters;
...
@override
int get hashCode => Object.hash(runtimeType,bookId,const DeepCollectionEquality().hash(_chapters),currentChapterIndex,selectedParagraphIndex,selectedWordIndex,prefsLoaded);
...
/// Create a copy of BookReadingState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? bookId = null,Object? chapters = null,Object? currentChapterIndex = null,Object? selectedParagraphIndex = freezed,Object? selectedWordIndex = freezed,Object? prefsLoaded = null,}) {
