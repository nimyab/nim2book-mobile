...
@override
String toString() {
  return 'Author(id: $id, name: $name, createdAt: $createdAt, books: $books, personalBooks: $personalBooks)';
}
...
class _Author implements Author {
  const _Author({required this.id, required this.name, required this.createdAt, final  List<Book>? books, final  List<PersonalUserBook>? personalBooks}): _books = books,_personalBooks = personalBooks;
